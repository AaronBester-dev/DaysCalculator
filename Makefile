all: daysCalculatorA.c daysCalculatorB.c daysCalculatorC.c daysCalculatorD.c daysCalculatorE.c
		gcc -ansi -o daysCalculatorA daysCalculatorA.c | gcc -ansi -o daysCalculatorB daysCalculatorB.c | gcc -ansi -o daysCalculatorC daysCalculatorC.c | gcc -ansi -o daysCalculatorD daysCalculatorD.c | gcc -ansi -o daysCalculatorE daysCalculatorE.c
