 ...
 *   Execution: ./daysCalculatorD today 17-12-2019 include
 */
...
instead of giving the user the error message"
*/

if(argc < 3){
  printf("Usage:./daysCalculatorD today dd2-mm2-yyyy2 include \n");
  return(1);
}
